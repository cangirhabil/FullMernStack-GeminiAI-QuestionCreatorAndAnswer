      ...
      <form onSubmit={onSubmit}>
          ...
          {mode === "register" && (
            <div className="space-y-2">
              ...
              <Input
                ...
                required
                className="h-12 px-4 rounded-xl border-gray-200 focus:border-blue-500 focus:ring-blue-500/20 transition-all"
        ...
        <CardFooter className="flex flex-col gap-4 px-8 pb-8">
          <Button 
            type="submit" 
            disabled={submitting} 
            className="w-full h-12 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center gap-2"
          >
            {submitting ? (
              <>
          ...
          <Button
            type="button"
            variant="ghost"
            className="w-full h-10 text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-xl transition-colors"
